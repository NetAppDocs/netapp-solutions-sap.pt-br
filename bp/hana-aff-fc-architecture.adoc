...
Para obter informações detalhadas sobre a solução de backup e recuperação do SAP HANA, consulte link:../backup/hana-sc-generic-scope.html["Backup e recuperação do SAP HANA com o SnapCenter"^].
