...
| Desative a atualização do tempo de acesso, exceto o volume SID_shared  a| 
...
| ONTAP 9: Defina o tamanho máximo de transferência TCP NFS como 1MB  a| 
defina o <vserver_name> -vserver -tcp-max-xfer-size 1048576 set admin



| ONTAP 8: Defina o tamanho de leitura e gravação NFS para 64KB  a| 
definir o nfs avançado modificar -vserver <vserver-name> -v3-tcp-max-read-size 65536 nfs modificar -vserver <vserver-name> -v3-tcp-max-write-size 65536 set admin
...
| ONTAP 9: Defina o tamanho máximo de transferência TCP NFS como 1MB | defina o <vserver_name> -vserver -tcp-max-xfer-size 1048576 set admin 


| ONTAP 8: Defina o tamanho de leitura e gravação NFS para 64KB | defina o <vserver_name> -vserver -tcp-max-xfer-size 65536 set admin 
...
NOTE: Se você estiver usando NFSV4,1, o pNFS pode ser ativado e usado.
