...
| ONTAP 8: Defina o tamanho de leitura e gravação NFS para 64KB | definir o nfs avançado modificar -vserver <vserver-name> -v3-tcp-max-read-size 65536 nfs modificar -vserver <vserver-name> -v3-tcp-max-write-size 65536 set admin 
|===
