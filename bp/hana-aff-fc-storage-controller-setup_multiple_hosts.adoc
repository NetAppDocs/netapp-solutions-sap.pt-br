...
NOTE: NetApp ASA systems não suportam NFS como protocolo. NetApp recomenda o uso de um sistema AFF ou FAS adicional para os  `/hana/shared` e  `/lss/shared` sistemas de arquivos.
