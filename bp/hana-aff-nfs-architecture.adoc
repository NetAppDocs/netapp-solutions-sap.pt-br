...
image:saphana_aff_nfs_image2a.png["Oito hosts do SAP HANA conectados a um par de alta disponibilidade de storage (HA)"]
...
image:saphana_aff_nfs_image3a.png["Hosts SAP HANA adicionais a um par de HA com controladora de storage existente"]
...
image:saphana_aff_nfs_image4a.png["Par de HA adicional adicionado"]
...
image:saphana_aff_nfs_image6.png["Figura que mostra a caixa de diálogo de entrada/saída ou que representa o conteúdo escrito"]
