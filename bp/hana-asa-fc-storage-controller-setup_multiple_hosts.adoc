...
A tabela a seguir mostra a configuração de LUN de um sistema SAP HANA com múltiplos hosts 2+1.

|===
| Finalidade | LUNs | Volume lógico LVM 


| Host de dados 1 | FC5_data_mnt00001_1 FC5_data_mnt00001_2 | FC5_data_mnt00001-vol 


| Host de dados 2 | FC5_data_mnt00002_1 FC5_data_mnt00002_2 | FC5_data_mnt00002-vol 


| Host de log 1 | FC5_log_mnt00001_1 FC5_log_mnt00001_2 | FC5_log_mnt00001-vol 


| Host de log 2 | FC5_log_mnt00002_1 FC5_log_mnt00002_2 | FC5_log_mnt00002-vol 
|===

NOTE: O volume /hana/shared deve ser acessível por todos os hosts SAP HANA e, portanto, geralmente é exportado usando NFS. Como os sistemas NetApp ASA não suportam NFS como protocolo, a NetApp recomenda o uso de um sistema AFF ou FAS adicional para o sistema de arquivos /hana/shared.
...
NOTE: Se o serviço SAP Local Secure Store (LSS) for utilizado, o  `/lss/shared/SID` diretório deve ser acessível em todos os hosts e, portanto, geralmente é exportado usando NFS. Como os sistemas NetApp ASA não suportam NFS como protocolo, a NetApp recomenda usar um sistema AFF ou FAS adicional para o sistema de arquivos /lss/shared.
...
. Forneça as informações necessárias:
+
.. o nome dos LUNs de log a serem combinados com LVM, por exemplo `FC5_log_mnt00001`
.. a quantidade de LUNs a serem combinados com LVM, por exemplo 2
