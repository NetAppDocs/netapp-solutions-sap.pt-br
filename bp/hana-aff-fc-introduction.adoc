...
A família de produtos NetApp AFF/ ASA A-Series foi certificada para uso com SAP HANA em projetos de integração de data center (TDI) personalizados.
...
* https://help.sap.com/docs/SAP_HANA_PLATFORM/eb3777d5495d46c5b2fa773206bbfb46/0b15a92d554c4941a452c9ca127f8c70.html["Integração do SAP HANA Tailored Data Center"^]
