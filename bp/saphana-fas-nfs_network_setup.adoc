...
* Em uma configuração VMware, adaptadores de rede VMXNET3 dedicados devem ser atribuídos a cada máquina virtual em execução. Consulte os artigos relevantes mencionados no link:saphana-fas-nfs_introduction.html["Introdução"] para obter mais requisitos.
...
image:saphana-fas-nfs_image11a.png["Figura que mostra a caixa de diálogo de entrada/saída ou que representa o conteúdo escrito"]
