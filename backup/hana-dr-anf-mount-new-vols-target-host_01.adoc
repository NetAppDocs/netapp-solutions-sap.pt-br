...
summary: 'Os volumes agora podem ser montados no host de destino, com base no `/etc/fstab` arquivo criado anteriormente.' 
---
...
[role="lead"]
Os volumes agora podem ser montados no host de destino, com base no `/etc/fstab` arquivo criado anteriormente.
