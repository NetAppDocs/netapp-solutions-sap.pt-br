...
....
Você pode encontrar mais informações sobre as opções de implantação do plug-in SAP HANA e a configuração do armazenamento de usuários em link:hana-sc-generic-scope.html["Backup e recuperação do SAP HANA com o SnapCenter"^].
